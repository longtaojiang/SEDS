...
class csl_DataLoader_train_pose(Dataset):
    """CSL dataset loader."""
    def __init__(
            self,
            subset,
    ...
    def _get_pose(self, video_file_path):
        ...
        ori_img_size = np.array([self.original_size, self.original_size], dtype=np.float32)
...
def csl_train_pose_collate_fn(batch, padding=6):
    '''
